...
/**
 * Required for indexing a graph data with neo4j
 * Configuration in solrconfig.xml is as follows default values shown
 * solrconfig.xml :
 * <pre>
 * &lt;updateRequestProcessor&gt;
 *   &lt;factory name="standard" class="solr.ChainedUpdateProcessorFactory" default="true"&gt;
 *     &lt;chain class="com.neo.search.index.NeoSocialUpdateProcessorFactory"&gt;
 ...
 */
public class NeoSocialUpdateProcessorFactory extends UpdateRequestProcessorFactory{
	...
	/**
	 * {@link UpdateRequestProcessorFactory}
	 * parses args in solrconfig.xml
	 * takes neoUserId and neoRelationshipField 
	 */
	@Override
...
class NeoSocialUpdateProcessor extends UpdateRequestProcessor {
	...
	public NeoSocialUpdateProcessor(UpdateRequestProcessor next, String userId, String relationshipField) {
		super(next);
		this.next = next;
		this.userId = userId;
	...
	/**
	 * if a document contains the neoUserId field as defined in {@link NeoSocialUpdateProcessorFactory}
	 * then the neoUserId is added to the neo social graph, and the rest of the document is indexed
	 * if a document contains a neoRelationshipField (uid:uid2:uid3...) then a relationship is added
	 * to those nodes 
	 * <pre>
	 * uid -> uid2
	 * uid -> uid3
	 ...
	 * </pre>
	 * 
	 * Relationship documents are not indexed in solr, they should only contain a relationship field
	 * 
	 */
	@Override
	...
	/**
	 * 
	 * @param userIds a string containing uid:uid2:uid3:uid4....
	 * adds relationships from uid to uid2, uid3 etc..
	 */
