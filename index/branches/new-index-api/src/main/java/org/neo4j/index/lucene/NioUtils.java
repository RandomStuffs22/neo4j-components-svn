...
{
    static String readLengthAndString( ReadableByteChannel channel,
    ...
    static String readString( ReadableByteChannel channel, ByteBuffer buffer,
    ...
    static Integer readInt( ReadableByteChannel channel, ByteBuffer buffer ) throws IOException
    {
        buffer.clear();
        buffer.limit( 4 );
    ...
    static void writeLengthAndString( FileChannel channel, ByteBuffer buffer, String value )
            throws IOException
    {
