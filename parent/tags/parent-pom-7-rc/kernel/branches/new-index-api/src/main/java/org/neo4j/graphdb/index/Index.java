...
public interface Index<T extends PropertyContainer>
{
    ...
    /**
     * Removes key/value pairs for {@code entity} from the index. The query
     * object can represent a query string or a query object, both specific
     * to the implementation of this particular index. Matching entries for
     * the given query will get removed from this index.
     * 
     * @param entity the entity (i.e {@link Node} or {@link Relationship})
     * to dissociate the matching entries from.
     * @param queryOrQueryObjectOrNull the query which decides which entries
     * are to be removed. It can be a string query or a query object.
     * Irregardless of what, it's implementation-specific.
     */
    void remove( T entity, Object queryOrQueryObjectOrNull );
    
    /**
     * Removes key/value pairs from the index. The query object can represent a
     * query string or a query object, both specific to the implementation of
     * this particular index. Matching entries for the given query will get
     * removed from this index.
     * 
     * @param queryOrQueryObject the query which decides which entries
     * are to be removed. It can be a string query or a query object.
     * Irregardless of what, it's implementation-specific.
     */
