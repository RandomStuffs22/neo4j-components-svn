...
abstract class Primitive
{
    ...
    protected abstract void changeProperty( NodeManager nodeManager,
            int propertyId, Object value );

    protected abstract int addProperty( NodeManager nodeManager,
    ...
    public Object getProperty( NodeManager nodeManager, String key )
            ...
            Object defaultValue )
    {
        ...
        PropertyData property = getSlowProperty( nodeManager, addMap, skipMap,
                key );
        if ( property != null )
        {
            return getPropertyValue( nodeManager, property );
    ...
    private Object getPropertyValue( NodeManager nodeManager,
            PropertyData property )
    {
    ...
    protected void setRollbackOnly( NodeManager nodeManager )
    {
            ...
            NodeManager nodeManager )
    {
        ...
        for ( Map.Entry<Integer,PropertyData> entry : propertyMap.entrySet() )
        {
            ...
            Object value = getPropertyValue( nodeManager,
                    propertyMap.get( index.getKeyId() ) );
            props.add( new PropertyEventData( index.getKey(), value ) );
        }
        return props;
   }

    protected Object getCommittedPropertyValue( NodeManager nodeManager,
            String key )
   {
        ensureFullLightProperties( nodeManager );
       for ( PropertyIndex index : nodeManager.index( key ) )
