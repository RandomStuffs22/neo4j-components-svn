...
class NodeImpl extends Primitive
{
    ...
    List<RelTypeElementIterator> getAllRelationships( NodeManager nodeManager )
    {
        ...
        for ( String type : relationshipMap.keySet() )
        {
            ...
            {
                relTypeList.add( RelTypeElement.create( nodeManager, type,
                        this, src, add, remove ) );
            }
        }
        if ( addMap != null )
            ...
            NodeManager nodeManager, RelationshipType... types )
    {
        ...
        for ( RelationshipType type : types )
        {
            ...
            if ( src != null || add != null )
            {
                relTypeList.add( RelTypeElement.create( nodeManager,
                        type.name(), this, src, add, remove ) );
            }
        }
        return relTypeList;
    }
    ...
    {
        return new IntArrayIterator( getAllRelationships( nodeManager ), this,
                dir, nodeManager, new RelationshipType[0] );
    }
            ...
            RelationshipType type )
    {
        ...
        return new IntArrayIterator(
                getAllRelationshipsOfType( nodeManager, types ),
    ...
    public Relationship getSingleRelationship( NodeManager nodeManager,
            RelationshipType type,
        Direction dir )
    {
        RelationshipType types[] = new RelationshipType[] { type };
    ...
    void addRelationship( NodeManager nodeManager, RelationshipType type,
            int relId )
    {
    ...
    void removeRelationship( NodeManager nodeManager, RelationshipType type,
            int relId )
    {
    ...
    public Relationship createRelationshipTo( NodeManager nodeManager,
            Node otherNode,
        RelationshipType type )
    {
