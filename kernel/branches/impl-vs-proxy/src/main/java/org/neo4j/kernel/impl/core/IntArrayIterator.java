        ...
        do
        {
            if ( currentTypeIterator.hasNext() )
            {
                ...
                try
                {
                    ...
                    if ( direction == Direction.INCOMING
                         && possibleElement.getEndNode().getId() == fromNode.getId() )
                    {
                        nextElement = possibleElement;
                        return true;
                    }
                    else if ( direction == Direction.OUTGOING
                              && possibleElement.getStartNode().getId() == fromNode.getId() )
                    {
                        nextElement = possibleElement;
                        return true;
                    }
            ...
            while ( !currentTypeIterator.hasNext() )
            {
                ...
                else
                {
                    ...
                    List<RelTypeElementIterator> list = Collections.emptyList();
                    if ( types.length == 0 )
                    {
                    ...
                    {
                        list = fromNode.getAllRelationshipsOfType(
                                nodeManager, types );
                    }
