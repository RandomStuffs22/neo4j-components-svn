...
public class TobiasCompetitionEntry implements CompetitionEntry
{
    public ShortestPath shortestPath( int maxlength, RelationshipType type,
            Direction dir ) throws NotImplementedException
    {
        return new ShortestPathAlgorithm( maxlength,
                RelationshipExpander.forTypes( type, dir ) );
    }
    ...
    {
        return new ShortestPathAlgorithm( maxlength,
                RelationshipExpander.forTypes( type1, dir1, type2, dir2 ) );
    }
    ...
    {
        return new ShortestPathAlgorithm( maxlength,
                RelationshipExpander.forTypes( type1, dir1, type2, dir2, more ) );
    }
}
