...
public interface IndexService
{
    ...
    /**
     * Disassociates a node from all its indexed key-value pairs.
     * If no such association exist this method silently returns.
     ...
     * 
     * @param node the node to disassociate from all its key-value pairs.
     * @param key the key in the key-value pair.
     */
    void removeIndex( Node node, String key );
    
    /**
     * Removes all key-value pairs which {@code key} is part of, i.e. clearing
     * an entire index {@code key}.
     * Implementations may choose to not implement this method and should
     * in such a case throw {@link UnsupportedOperationException}.
     * 
