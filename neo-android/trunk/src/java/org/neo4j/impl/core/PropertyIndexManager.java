...
import neo.javax.transaction.Status;
import neo.javax.transaction.Synchronization;
import neo.javax.transaction.Transaction;
...
public class PropertyIndexManager
{
    ...
    private Transaction getTransaction()
    {
        ...
        catch ( neo.javax.transaction.SystemException e )
        {
    ...
    void setRollbackOnly()
    {
        ...
        catch ( neo.javax.transaction.SystemException se )
        {
            se.printStackTrace();
        }
    }
